...
get the app created:
    ...
    Creating helloworld... done, stack is cedar
    http://helloworld.herokuapp.com/ | git@heroku.com:helloworld.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://helloworld.herokuapp.com deployed to Heroku

    To git@heroku.com:helloworld.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://helloworld.herokuap.com
    ["Hello" :from Heroku]
